...
const PracticeArena = ({ exp, setExp, totalExp, setTotalExp, stats, setStats, setActiveTab, activeCompany, userProfile }) => {
              ...
              {questions.map((_, idx) => (
                <button 
                  ...
                  style={{
                    ...
                    background: answers[idx] !== undefined ? 'var(--brand-blue)' : (currentQ === idx ? 'var(--bg-primary)' : 'var(--bg-secondary)'),
